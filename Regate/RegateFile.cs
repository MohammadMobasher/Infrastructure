namespace Regate
{
    ...
    {
        public static string Build(string name = "", string value = "", bool isRequired = false, string validType = "")
        {
            ...
            var markup = $@"
                ...
                <a href='/file/file/?field={name}&validType={validType}'
                   onclick='PopupCenter(this.href, ""ScyllaUploadFile"", 600, 300); return false;'
