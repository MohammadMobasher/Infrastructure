...
{
    public class Routine2Repository : GenericRepository<DataLayer.Entities.ExireRoutine.Routine2>
    {
        ...
        public Routine2Repository(DatabaseContext dbContext) : base(dbContext)
        ...
        public List<int> GetUserEntityIds(int routineId, int userId, string dashboardEnum)
        {
            ...
            var model = DbContext.Routine2Log.AsNoTracking()
        ...
        {
            var model = DbContext.Routine2Step.AsNoTracking()
        ...
        /// <summary>
        /// عنوان یک روتین بازیابی می شود
        /// </summary>
        /// <param name="routineId">شماره روتین</param>
        /// <param name="step">نام مرحله</param>
        /// <returns></returns>
        public string GetRoutineRoleTitle(int routineId, int step)
        {
            var routineRole = DbContext.Routine2Role
        ...
        /// <summary>
        /// گرفتن کل اطلاعات یک روتین
        /// </summary>
        /// <param name="routineId">شماره روتین</param>
        /// <returns></returns>
        public Routine2FullDTO GetRoutineFull(int routineId)
        {
            var model = DbContext.Routine2.AsNoTracking()
                .AsNoTracking()
        ...
        /// <summary>
        /// لاگهای مربوط به یک روتین برای یک موجیت خاص بازیابی میشود
        /// </summary>
        /// <param name="routineId">شماره روتین</param>
        /// <param name="entityId">شماره موجودیت خاص</param>
        /// <returns></returns>
        public List<Routine2Log> GetLogs(int routineId, int entityId)
        {
            return DbContext.Routine2Log.AsNoTracking()
                .Where(q => q.RoutineId == routineId &&
                            q.EntityId == entityId) 
